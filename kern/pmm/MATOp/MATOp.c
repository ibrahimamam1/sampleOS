...
static unsigned int next = VM_USERLO_PI; //next pointer which hjold index of next page to be allocated
/**
...
unsigned int palloc()
{
   ...
   unsigned int begin = next;
    ...
    //if we reach the end we can check from the beginning again
