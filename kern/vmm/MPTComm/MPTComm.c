 ...
 * and clears (set to 0) all page table entries for this newly mapped page
 * table. It returns the page index of the newly allocated physical page. In the
 * case when there's no physical page available, it returns 0.
 */
